...
= d�finir dans ce vault un secret, ici une cl� SSH
= d�ployer une VM Linux utilisant ce secret comme cl� publique SSH
==================================================================

idem proc�dure VM Windows Mot de passe

/!\ le fichier .parameters.json est un peu diff�rent
...
--- D�ployer la VM avec mot de passe stock� dans Azure Key Vault � partir d'un mod�le ARM et d'un fichier de param�tre contenant le chemin vers le secret dans le Vault
New-AzureRmResourceGroupDeployment -ResourceGroupName RG-Test -TemplateFile .\azuredeployVMsshVault.json -TemplateParameterFile .\azuredeployVMsshVault.parameters.json
